...
% *** set target networks ***
Atgt_set    = HD_MEA_binary_single; spike_sortd = 1;
...
HDMEA1449gendata = b;
save('HDMEA1449gendata.mat','HDMEA1449gendata','-v7.3')
HDMEA1449parameterspace = params;
save('HDMEA1449parameterspace.mat','HDMEA1449parameterspace','-v7.3')
HDMEA1449observed = observed;
save('HDMEA1449observed.mat','HDMEA1449observed','-v7.3')
