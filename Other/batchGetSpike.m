function batchGetSpike 
    ...
    files = dir('W*.mat');  % where your .mat files are 
    ...
    for file = 1:length(files)
        ...
        %pSpikes = sparse(getSpikeMatrix(data, 'Prez', 4));
         ...
         multiplier = 5;
         [mSpikes, ~, thresholds] = getSpikeMatrixAlex(data, 'Manuel', multiplier, L, fs, refPeriod_ms); %AD added, need to adjust loss parameter
