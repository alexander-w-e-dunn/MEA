function networkSpikeData = batchNetworkSpikeDetect(method, networkSpikeDetectParam, fs, jitterCriteria,fileList)
%{ 
batchNetworkSpikeDetect performs network spike detection in batch 
and saves a table summarising the results

% Author: Tim Sit 
% Last update: 20200519 Alex Dunn 
...
for file = 1:length(fileList) 
    ...
    try
        spikeMatrix = data.cSpikes; % numSample x numChannel sparse double
    catch
        spikeMatrix = data.mSpikes;
    end
