...
rawRootPath = 'D:\MECP2_2019_AD\Scripts_and_Output\S1.2.File_Conversion_Output\';
...
for file = 1:numFileWithNetworkSpike 
    ...
    spikestring = loadPath{1};
    spikestring = spikestring(strfind(spikestring,'Spikes')-2 : end-4);
    rawData = load(strrep(loadPath{1}, spikestring, '')); %{1} basically does cell2str
