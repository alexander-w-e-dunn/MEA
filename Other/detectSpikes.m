function [spikeTrain, finalData, threshold] = detectSpikes(data, method, multiplier, L,fs,refPeriod_ms)
...
%% AD: define input/data and choose method

%cd D:\MECP2_2019_AD\3.0.SpikesToDetect\MPT140119_2A_DIV35
%load('MPT140119_2A_DIV35_26.mat')
%data = dat';
%cd 'C:\Users\alexd\OneDrive - University Of Cambridge\Cam\MPhil Work\1.Project\Analysis\Step_2_detect_spikes\Alex'
%method = 'Tim'; multiplier = 12;
%method = 'Prez'; multiplier = 12
...
if strcmp(method,'Tim')
    ...
    filterOrder = 3; %changed from 3 to 5 by AD; changed back as MSpaper 2015 is 3rd order
...
if strcmp(method,'cwt')
    ...
    spikeFrames = detect_spikes_wavelet(filteredData, fs/1000, Wid, Ns, option, L, wname, PltFlg, CmtFlg, refPeriod_ms); 
...
%assignin('base','threshold',threshold); %added by AD to save variables automatically
%assignin('base','finalData',finalData);
%assignin('base','spikeTrain',spikeTrain); 
%% absolute threshold 
