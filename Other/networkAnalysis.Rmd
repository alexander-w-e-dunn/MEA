...
```{r}
network <- readMat('C:/Users/alexd/OneDrive - University Of Cambridge/Cam/PhD/Project/Data/Organoid/AdjM/191210_FTD_slice1_DIV_g04_2018_mSpikes_5_adjM_reord.mat')
#network <- readMat('D:\MECP2_2019_AD\Scripts_and_Output\S1.2.File_Conversion_Output\190830_slice1stim8_current_cSpikes_L-0.1254_adjM.mat')
#AD: remove channels variable...
network<-network[2] #needed to change index from 1 to 2
...
#AD: define net.bg as this has not been defined above - ask tim 
net.bg<-network
...
# Chane border colour 
V(network.pruned)$frame.color = "black" # white, black, or grey (or NA)

# save as eps 
postscript("C:/Users/alexd/OneDrive - University Of Cambridge/Cam/PhD/Project/Data/Organoid/Figures/networkplot_threshold0.8_degree1_noBorder_edgeWeight_veretexDegree_greyborder.eps", width = 500, height = 500)
...
legend(x = 1.2, y = 1, c("0.8", "0.9", "1"), col=c("grey","grey", "grey"), lwd = c(1, 2.25, 4), box.col = "white", title = "Correlation")
...
legend(x = 1.2, y = 0.25, c("1", "5", "10"), col = c("black", "black", "black"), pch = 21, pt.bg = "orange", box.col = "white", title = "Node degree", pt.cex = c(0.75, 2, 4), y.intersp = 1.2, x.intersp = 1.5)
...
library(ggnetwork)
# save as eps 
postscript("C:/Users/alexd/OneDrive - University Of Cambridge/Cam/PhD/Project/Data/Organoid/Figures/networkplot_legend_attempt1.eps", width = 500, height = 500)
