...
%             thr = value for thresholding as a proportion of connections
...
% thr = 0.4;
% plot_wu_thr_network_fcn(fileName,thrOption,thr)
...
function plot_wu_thr_network_fcn(fileName,thrOption,thr)
