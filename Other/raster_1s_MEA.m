...
clear all; close all
% fileName = '200127_FTDOrg_GrpD_5B_Slice7_mSpikes_3_CTRL_spikeMat.mat'
% fileName = '200127_FTDOrg_GrpD_5B_Slice7_mSpikes_3.mat'
%  fileName = '200127_FTDOrg_GrpA_3A_Slice8_mSpikes_3.mat';
%  fileName = '200127_FTDOrg_GrpA_3A_Slice8_mSpikes_3_CTRL_spikeMat.mat'
 fileName = '200127_FTDOrg_GrpA_3A_Slice8_mSpikes_3_synth_data2.mat'
% fileName = 'MPT190403_6B_DIV50TTXAFTER0001_cSpikes_L-0.0627_RF1.mat'
...
elseif ~~exist('rand_spikeMat_sparse_all')
    ...
    fs = 1000;
elseif ~~exist('shuffled_spikeMat_sparse_all')
    spikeMatrix = full(shuffled_spikeMat_sparse_all{1,1});
else
...
%% save
figname = strcat(fileName(1:end-4),'_1sRaster.png') ;
saveas(f1,figname);
