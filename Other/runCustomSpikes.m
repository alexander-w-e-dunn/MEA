...
custom_spike_scriptsDir = 'C:\Users\alexd\OneDrive - University of Cambridge\Cam\PhD\Project\Data&CodeBackup\Scripts\MEApipelineV1\WATERS';
...
filestruct = dir([dataPath  '\' 'MPT200209_8B_DIV*.mat']); files = struct2cell(filestruct)'; files = files(:,1);
