...
%     EdgeNum         = matrix giving channel indices for each edge
% 
...
function [adjM,thr_adjM,thr,synth_adjMs,channels,EdgeIDs,EdgeNum] = threshold_MEA_STTC(fileName,lag,fs,numPermutations,method,alpha)
